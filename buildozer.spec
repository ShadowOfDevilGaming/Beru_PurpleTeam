...
#   * empty  -> buildozer runs `git clone -b ''` -> git error 128.
#   * master -> auto-downloads NDK r28c -> extract fails ("error code 9").
#   * v2026.05.09 -> builds Python 3.14 (unstable), compile crashes in ~6 min.
# v2024.01.21 is the last well-tested release: builds stable Python 3.11,
# respects the pinned NDK 27.3, compiles in ~15 min.
